...
namespace LocalLibrary.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update LocalLibraryDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LocalLibraryEfCoreEntityExtensionMappings to extend the IdentityUser entity
